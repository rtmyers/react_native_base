...
function updateSuspenseComponent(current, workInProgress, renderExpirationTime) {
  ...
  if ((workInProgress.effectTag & DidCapture) !== NoEffect || shouldRemainOnFallback(suspenseContext, current, workInProgress)) {
...
function commitUnmount(current, renderPriorityLevel) {
...
function unmountHostComponents(current, renderPriorityLevel) {
...
function commitDeletion(current, renderPriorityLevel) {
  if (supportsMutation) {
